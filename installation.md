# customer-churn guide installation
...
If your are using [virtualenv](https://virtualenv.pypa.io/en/latest/) or [venv](https://docs.python.org/3/library/venv.html) this template is customized for them and in fact you have already created a virtual environment ``env/``, you just need to access and install the packages with [pip](https://pypi.org/project/pip/)
